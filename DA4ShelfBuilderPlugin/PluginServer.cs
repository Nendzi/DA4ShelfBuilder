...
{
    [Guid("2341203d-8527-47ee-882b-c4cc2bf871a4")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": DA4ShelfBuilderPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": DA4ShelfBuilderPlugin: deactivating... ");
